...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xsl:template match="/">
		...
		<xsl:variable name="filePath" select="'tmp/Brocade_FCSwitch_Port/PortsInLogicalSwitch_Req_Folder/'"/>
                ...
                <SIMPLEREQ>
                    <IMETHODCALL NAME="Associators">
                        ...
                        <IPARAMVALUE NAME="AssocClass">
                            <CLASSNAME NAME="Brocade_PortInSwitch" />
                        </IPARAMVALUE>
                        <IPARAMVALUE NAME="ResultClass">
                            <CLASSNAME NAME="Brocade_SwitchFCPort" />
                        </IPARAMVALUE>
						<IPARAMVALUE NAME="PropertyList">
							<VALUE.ARRAY>
								<VALUE>MaxSpeed</VALUE>
								<VALUE>PortAvailability</VALUE>
								<VALUE>PortNumber</VALUE>
								<VALUE>DetailedPortState</VALUE>
								<VALUE>LinkTechnology</VALUE>
								<VALUE>PermanentAddress</VALUE>
								<VALUE>EnabledState</VALUE>
								<VALUE>PortType</VALUE>
								<VALUE>DeviceID</VALUE>
								<VALUE>NPIVEnabled</VALUE>								
							</VALUE.ARRAY>
						</IPARAMVALUE>						
					</IMETHODCALL>
                </SIMPLEREQ>
