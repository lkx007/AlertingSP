...
[/#list]
	...
	<collecting-configuration id="VMAX-BE-DIRECTORS" variable="source device partgrp parttype directid name" timeout="900" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
...
[/#list]
	...
	<collecting-configuration id="VMAX-DEVICES" variable="source device parttype part name director port" timeout="900" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
...
[/#list]
		...
		<timestamp type="use-system-time"/>
		<value name="Capacity" value="/Device/Flags[meta != 'Member']/../Capacity/megabytes" unit="GB">
			<property-set>Properties</property-set>
		</value>
		<value name="RAIDOverHead" value="/Device/Flags[meta != 'Member']/../Capacity/megabytes" unit="GB">
			<property-set>Properties</property-set>
		</value>
		...
		<property-set name="Properties">
			...
			<property name="mainpool" value="../../Dev_Info/thin_pool_name"/>
	...
	<collecting-configuration id="VMAX-DEVICES-DATADEV" variable="source device parttype part name director port" timeout="900" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
		<for-each>Device</for-each>
		<data>
			<data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
			<input>conf/vmax.cmd symdev -output XML -sid (host) list -v -datadev</input>
[#else]
			<input>conf/vmax.sh symdev -output XML -sid (host) list -v -datadev</input>
[/#if]
[#list vmax as vmax]
[#assign serialnb = vmax.serialnb?string]
			<host>${serialnb?left_pad(12, "0")}</host>
[/#list]
	...
	<collecting-configuration id="VMAX-DEVICES-POOL" variable="source device parttype part poolname name" timeout="900" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
		<for-each>Device</for-each>
		<data>
			<data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
...
[/#list]
		...
		<timestamp type="use-system-time"/>
		<value name="Capacity" value="/DevicePool/total_tracks_mb" unit="GB">
			<property-set>symProperties</property-set>
		</value>
		<value name="UsedCapacity" value="/DevicePool/total_used_tracks_mb" unit="GB">
			<property-set>symProperties</property-set>
		</value>
		<value name="FreeCapacity" value="/DevicePool/total_free_tracks_mb" unit="GB">
			<property-set>symProperties</property-set>
		</value>
		<property-set name="symProperties">
			<property name="device" type="host" value=""/>
...
[/#list]
		...
		<timestamp type="use-system-time"/>
		<value name="RemoveMe" value="//SG_Info[Masking_views='Yes']/../DEVS_List/Device/megabytes" unit="GB">
			<!-- for enrichment -->
			<property name="mvsgname" type="data" value="../../../SG_Info/name"/>
			<property-set>symProperties</property-set>
		</value>
		<value name="RemoveMe" value="//SG_Info[Masking_views='No']/../DEVS_List/Device/megabytes" unit="GB">
			<!-- for enrichment -->
...
[/#list]
	...
	<collecting-configuration id="VMAX-TIER-POOL" variable="source device parttype tiername part name" timeout="900" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
		<for-each>Tier_Info</for-each>
		<data>
			<data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
...
[/#list]
		...
		<value name="RemoveMe" value="//Device/capacity" unit="">
