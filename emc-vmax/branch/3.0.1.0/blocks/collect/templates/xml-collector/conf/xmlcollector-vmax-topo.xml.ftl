...
<configuration xmlns="http://www.watch4net.com/XMLCollector" 
    ...
    <collecting-configuration id="VMAX-SE-TOPO-ARRAYS" variable="source device name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
        <data>
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-BE-DIRECTORS" variable="source device partgrp parttype directid name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-FE-DIRECTORS" variable="source device partgrp parttype part name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
        <for-each>Director</for-each>
        <data>
            <data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-PORTS" variable="source device parttype director part name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
        <for-each>Director</for-each>
        <data>
            <data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-DISKS" variable="source device parttype part name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
        <for-each>Disk</for-each>
        <data>
            <data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
            <input>conf/vmax.cmd symdisk -output XML -sid (host) list -v</input>
[#else]
            <input>conf/vmax.sh symdisk -output XML -sid (host) list -v</input>
[/#if]
[#if vmax??]
[#list vmax as vmax]
[#assign serialnb = vmax.serialnb?string]
...
[/#if]
        ...
        <property-set name="symProperties">
            ...
            <property name="serialnb" type="host" value=""/>
            <property name="arraytyp" type="hard-coded" value="Symmetrix"/>
            <property name="part" type="data" value="if (contains(../disk_location, 'External') or  contains(../disk_location, 'Encapsulated')) then (concat(../ident, ':', ../spindle_id)) else (concat(../ident, ':', ../interface, ' ', ../tid))"/>
    ...
    <collecting-configuration id="VMAX-SE-TOPO-ACCESS1" variable="source device parttype part directid port initwwn hostlun initgrp name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
...
[/#if]
        ...
        <value name="Capacity" value="/Masking_View/View_Info/Initiators/wwn/../../Totals/total_dev_cap_mb" unit="GB">
            <property-set>MaskingViewsPropertiesWWN</property-set>
        </value>
        
        <value name="MVLunCapacity" value="/Masking_View/View_Info/Device/capacity[1]" unit="">
        ...
        <property-set name="MappingDataProperties">
            ...
            <property name="initwwn" type="data" value="string-join(../../../Initiators/wwn,',')"/> 
        ...
        <property-set name="MaskingViewsPropertiesWWN">
            ...
            <property name="sstype" type="hard-coded" value="Block"/>
            <property name="device" type="host" value=""/>
            <property name="datagrp" type="data" value="ends-with(../../init_grpname, '*')"> 
            ...
            <property name="partsngr" type="hard-coded" value="N/A"/>
        ...
        <property-set name="LunsProperties">
            ...
            <property name="sstype" type="hard-coded" value="Block"/>
            <property name="device" type="host" value=""/>
            <property name="datagrp" type="hard-coded" value="VMAX-ACCESS-LUN"/>
            <property name="devtype" type="hard-coded" value="Array"/>
            <property name="parttype" type="hard-coded" value="AccessToLUN"/> 
            <property name="part" type="data" value="concat(../../view_name,'|',../dev_name)"/>
            <property name="partid" type="data" value="concat(../../view_name,'|',../dev_name)"/>
            <property name="viewname" type="data" value="../../view_name"/>
            <property name="lunname" type="data" value="../dev_name"/>
            <property name="ismasked" type="data" value="exists(../../Initiators/wwn | ../../init_grpname)"> 
                <replace value="true" by="1"/> 
                <replace value="false" by="0"/> 
            </property>
            <property name="ismapped" type="data" value="exists(../../port_info/Director_Identification/port | ../../port_grpname)"> 
                <replace value="true" by="1"/> 
                <replace value="false" by="0"/> 
            </property>
        </property-set>
    ...
    <collecting-configuration id="VMAX-SE-TOPO-ACCESS2" variable="source device parttype part directid port initwwn hostlun initgrp name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
        <data>
            <data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
            <input>conf/vmax.cmd symaccess -output XML -sid (host) list view -detail</input>
...
[/#if]
        ...
        <timestamp type="use-system-time"/>
                ...
                <value name="Capacity" value="/SymCLI_ML/Symmetrix/Masking_View/View_Info/Initiators/group_name/../../Totals/total_dev_cap_mb" unit="GB">
        ...
        <property-set name="MaskingViewsPropertiesGroup">
            ...
            <property name="hostname" type="data" value="string-join(distinct-values((for $v in ../../view_name return /SymCLI_ML/Symmetrix/Masking_View/View_Info[view_name=$v]/Initiators/wwn/../user_node_name)),',')"/> 
            ...
            <property name="partsn" type="data" value="string-join((for $v in ../../view_name return /SymCLI_ML/Symmetrix/Masking_View/View_Info[view_name=$v]/Initiators/wwn),',')"/> 
            <property name="masked" type="hard-coded" value="true" />
            <property name="mapped" type="hard-coded" value="true" />
        </property-set>
    </collecting-configuration>
        
    <collecting-configuration id="DMX-SE-TOPO-MASKDB" variable="source device parttype part director port initwwn name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-BCVREPLICAS" variable="source device parttype part name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-SNAPREPLICAS" variable="source device parttype part name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-CLONEREPLICAS" variable="source device parttype part name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-RDFREPLICAS" variable="source device parttype part name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
        <for-each>Device</for-each>
        <data>
            <data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-RCOPYREPLICAS" variable="source device parttype part name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
        <for-each>Device</for-each>
        <data>
            <data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-POOLS-CAPACITY" variable="source device parttype part name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-POOLS-AVAILABILITY" variable="source device parttype part name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
        <for-each>DevicePool</for-each>
        <data>
            <data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-POOLS-SUBSCRIPTION" variable="source device parttype part name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
        <for-each>DevicePool</for-each>
        <data>
            <data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-TIERS" variable="source device parttype part sgname name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-TIER-POOL" variable="source device parttype tiername part name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-STORAGE-GROUPS" variable="source device parttype sgname part name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-DEVICES-POOL" variable="source device parttype part poolname name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
        <for-each>Device</for-each>
        <data>
            <data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
...
[/#if]
    ...
    <collecting-configuration id="VMAX-SE-TOPO-DEVICES" variable="source device parttype part name directid port" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
        <for-each>Device</for-each>
        <data>
            <data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
...
[/#if]
        ...
        <value name="RawCapacity" value="/Device/Capacity/megabytes" unit="GB">
            ...
            <property name="rawcap" 
                     value="if (exists(../../RAID_Group_Information)) 
                            then ( sum(../../RAID_Group_Information/Mirror_Info/Hyper_Devices/*/hyper_capacity_in_mb) )
                            else (
                                if (exists(../../RAID-6_Device | ../../RAID-5_Device)) 
                                then ( sum(../../RAID-6_Device/*/hyper_capacity_in_mb 
    ...
    <collecting-configuration id="VMAX-SE-TOPO-DEVICES-THIN" variable="source device parttype part name" timeout="${pollingperiod}" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
        <data>
            <data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
