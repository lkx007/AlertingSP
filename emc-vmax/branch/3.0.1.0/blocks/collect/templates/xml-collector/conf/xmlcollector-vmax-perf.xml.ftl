[#ftl]
[#if emcvmax??]
    [#assign pollingperiod = emcvmax.perf.pollingperiod]
[#else]
    [#assign pollingperiod = 7200]
[/#if]
...
<configuration xmlns="http://www.watch4net.com/XMLCollector" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.watch4net.com/XMLCollector xmlcollector.xsd ">
	...
	<collecting-configuration id="VMAX-UNIVMAX-PERF-Array" max-threads="10" timeout="${pollingperiod}" variable="datagrp device parttype part name" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob">
		<data>
	...
	<collecting-configuration id="VMAX-UNIVMAX-PERF-FEDirector " max-threads="10" timeout="${pollingperiod}" variable="datagrp device parttype part name" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob">
		<data>
			<include-contexts>conf/context.xml</include-contexts>
			<data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.remote.soap.ChainedWebServiceRequestsExecutor</data-accessor>
			<input/>
	...
	<collecting-configuration id="VMAX-UNIVMAX-PERF-BEDirector " max-threads="10" timeout="${pollingperiod}" variable="datagrp device parttype part name" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob">
		<data>
			<include-contexts>conf/context.xml</include-contexts>
			<data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.remote.soap.ChainedWebServiceRequestsExecutor</data-accessor>
			<input/>
	...
	<collecting-configuration id="VMAX-UNIVMAX-PERF-RDFDirector " max-threads="10" timeout="${pollingperiod}" variable="datagrp device parttype part name" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob">
		<data>
			<include-contexts>conf/context.xml</include-contexts>
			<data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.remote.soap.ChainedWebServiceRequestsExecutor</data-accessor>
			<input/>
	...
	<collecting-configuration id="VMAX-UNIVMAX-PERF-Disk " max-threads="10" timeout="${pollingperiod}" variable="datagrp device parttype partid name" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob">
		<data>
			<include-contexts>conf/context.xml</include-contexts>
			<data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.remote.soap.ChainedWebServiceRequestsExecutor</data-accessor>
			<input/>
	...
	<collecting-configuration id="VMAX-UNIVMAX-PERF-StorageGroup " max-threads="10" timeout="${pollingperiod}" variable="datagrp device parttype part name" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob">
		<data>
			<include-contexts>conf/context.xml</include-contexts>
			<data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.remote.soap.ChainedWebServiceRequestsExecutor</data-accessor>
			<input/>
	...
	<collecting-configuration id="VMAX-UNIVMAX-PERF-FEDirectorByPort " max-threads="10" timeout="${pollingperiod}" variable="datagrp device parttype director part name" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob">
		<data>
			<include-contexts>conf/context.xml</include-contexts>
			<data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.remote.soap.ChainedWebServiceRequestsExecutor</data-accessor>
			<input/>
	...
	<collecting-configuration id="VMAX-UNIVMAX-PERF-ThinPool " max-threads="10" timeout="${pollingperiod}" variable="datagrp device parttype part name" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob">
		<data>
			<include-contexts>conf/context.xml</include-contexts>
			<data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.remote.soap.ChainedWebServiceRequestsExecutor</data-accessor>
			<input/>
...
MAV.  Not used yet, mostly because the current implementation of the query fails (returns 0 device group).  Need to check with Unisphere team.
	<collecting-configuration id="VMAX-UNIVMAX-PERF-DeviceGroup " max-threads="10" timeout="${pollingperiod}" variable="datagrp device parttype part name" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob">
		<data>
			<include-contexts>conf/context.xml</include-contexts>
			<data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.remote.soap.ChainedWebServiceRequestsExecutor</data-accessor>
			<input/>
