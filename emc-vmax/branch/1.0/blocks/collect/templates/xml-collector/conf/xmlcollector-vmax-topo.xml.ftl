...
[/#list]
		...
		<timestamp type="use-system-time"/>
		<value name="Capacity" value="/Device/Capacity/megabytes" unit="MB">
	...
	<collecting-configuration id="MAX-DEVICES-THIN" variable="source device parttype part name" timeout="900" xml-job="com.watch4net.apg.v2.collector.plugins.xmlcollector.engine.NuxXmlJob" max-threads="10">
		<data>
			<data-accessor>com.watch4net.apg.v2.collector.plugins.outputparsing.executing.local.CLICommandExecutor</data-accessor>
[#if apg.os == 'windows'] 
