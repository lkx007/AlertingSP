...
[#else]
		<filter enabled="skip" name="MSS-VHF" next="FailOver" config="Variable-Handling-Filter/${module['variable-handling-filter'].instance}/conf/VHF-C.xml" />
[/#if]
