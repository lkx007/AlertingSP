...
<configuration xmlns="http://www.watch4net.com/TextOutputCollector"	xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.watch4net.com/TextOutputCollector textoutputcollector.xsd ">
	...
	<collecting-configuration name="VNX-DISKS" timeout="[#if use_advancedsettings]${perf.pollingperiod}[#else]300[/#if]">
		...
		<raw-value-group-list master-node="Bus .*" delete-after-group="true" variable-id="datagrp parttype part name">
			...
			<value-list name="Availability" leaf="State" unit="%">
				...
				<replace value="Removed" by="3"/>
				<replace value="Misplaced" by="4"/>
	...
	<collecting-configuration name="VNX-METAHEAD-LUNS-PERF">
		<parsing-configuration-file>conf/parser-metahead-perf.xml</parsing-configuration-file>
		<raw-value-group-list master-node="METALUN_INFO_.*" delete-after-group="false" variable-id="host datagrp parttype partid name">
			...
			<value-list name="ReadBlocksSPA" leaf="Host Blocks Read SPA" type="rate" unit="Nb/s"/>
			<value-list name="WriteBlocksSPA" leaf="Host Blocks Written SPA" type="rate" unit="Nb/s"/>
			<value-list name="ReadRequestsSPA" leaf="Host Read Requests SPA" type="rate" unit="Nb/s"/>
			<value-list name="WriteRequestsSPA" leaf="Host Write Requests SPA" type="rate" unit="Nb/s"/>
			<value-list name="BusySPA" leaf="Busy Ticks SPA" type="rate" unit="Nb/s"/>
			<value-list name="IdleSPA" leaf="Idle Ticks SPA" type="rate" unit="Nb/s"/>
			<value-list name="NonZeroRequestCountArrivalsSPA" leaf="Non-zero Request Count Arrivals SPA" type="rate" unit="Nb/s"/>
			<value-list name="SumOutstandingRequestsSPA" leaf="Sum of Outstanding Requests SPA" type="rate" unit="Nb/s"/>
			<value-list name="ReadBlocksSPB" leaf="Host Blocks Read SPB" type="rate" unit="Nb/s"/>
			<value-list name="WriteBlocksSPB" leaf="Host Blocks Written SPB" type="rate" unit="Nb/s"/>
			<value-list name="ReadRequestsSPB" leaf="Host Read Requests SPB" type="rate" unit="Nb/s"/>
			<value-list name="WriteRequestsSPB" leaf="Host Write Requests SPB" type="rate" unit="Nb/s"/>
			<value-list name="BusySPB" leaf="Busy Ticks SPB" type="rate" unit="Nb/s"/>
			<value-list name="IdleSPB" leaf="Idle Ticks SPB" type="rate" unit="Nb/s"/>
			<value-list name="NonZeroRequestCountArrivalsSPB" leaf="Non-zero Request Count Arrivals SPB" type="rate" unit="Nb/s"/>
			<value-list name="SumOutstandingRequestsSPB" leaf="Sum of Outstanding Requests SPB" type="rate" unit="Nb/s"/>
		</raw-value-group-list>
	</collecting-configuration>
