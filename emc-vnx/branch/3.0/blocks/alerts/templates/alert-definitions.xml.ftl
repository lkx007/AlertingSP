...
<AlertingConfig xmlns="http://www.watch4net.com/Alerting">
    ...
    <action-list id="1383144738127">
        ...
        <param-list name="trap-content">PROP.'device',PROP.'devtype',PROP.'part',PROP.'parttype',PROP.'name',VALUE,critical,Storage Processor Utilization PROP.'part' for is at VALUE%,VNXBlock-Collector,TMST,Performance</param-list>
    </action-list>
