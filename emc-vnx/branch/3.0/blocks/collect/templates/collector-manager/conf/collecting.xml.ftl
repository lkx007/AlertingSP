...
[/#if]
		...
		<filter enabled="true" name="VNX-PTFL" next="VNX-GPF1" config="Property-Tagging-Filter/${module['property-tagging-filter'].instance}/conf/property-tagging-filter-usedby.xml" />
...
[/#if]
		...
		<collector enabled="${blockenabled}" name="XML-API-ECOM" next="vnxblock-ptf" config="XML-Collector/${module['xml-collector'].instance}/conf/vnxblockalerts.xml" />
		<!-- File -->
		...
		<collector enabled="${fileenabled}" name="XML-API-CS" next="VNX-CRF-ALERTS" config="XML-Collector/${module['xml-collector'].instance}/conf/vnxfilealerts.xml" />
