...
<config xmlns="http://www.watch4net.com/spatial-aggregation-handler" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    -->
    <aggregation id="VNX-POOLUSABLECAPACITY" forward-input="true">

        <!-- To filter which metrics are aggregated here. -->
        <filter>((parttype=='Storage Pool' &amp; !(pooltype=='Snap Pool') &amp; !(pooltype=='Local Replica Mirror Pool') &amp; !(pooltype=='Remote Replica Mirror Pool') | parttype=='RAID Group') &amp; name=='Capacity') | name=='RemoveMeZero'</filter>
