...
<config xmlns="http://www.watch4net.com/spatial-aggregation-handler" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.watch4net.com/spatial-aggregation-handler spatial-aggregation-handler.xsd">
	<aggregation id="VNX-OVERHEAD-CAPACITY" forward-input="true">
		<filter> device &amp; serialnb &amp; sstype &amp; (!type=='rawfs' &amp; internal=='false' &amp; parttype='FileSystem' &amp; name=='OverheadCapacity') | name=='RemoveMeZero' </filter>
		...
		<properties>
			...
			<add name="name">NASFSOverheadCapacity</add>
