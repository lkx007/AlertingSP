...
<config xmlns="http://www.watch4net.com/spatial-aggregation-handler" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <aggregation id="VNX-ServiceLevel-UsableCapacity" forward-input="true">
        <filter>parttype=='LUN' &amp; name=='UsedCapacity' &amp; svclevel &amp; !svclevel=='Pool Contributor'</filter>
...
[/#if]
    ...
    <aggregation id="VNX-ServiceLevel-UsableCapacity-PoolContributor" forward-input="true">
        <filter>parttype=='LUN' &amp; name=='Capacity' &amp; svclevel=='Pool Contributor'</filter>
...
[/#if]
    ...
    <aggregation id="VNX-ServiceLevel-UsedCapacity" forward-input="true">
        <filter>parttype=='LUN' &amp; name=='UsedCapacity' &amp; isused=='1' &amp; !svclevel=='Pool Contributor'</filter>
...
[/#if]
    ...
    <aggregation id="VNX-ServiceLevel-UsedCapacity" forward-input="true">
        <filter>parttype=='LUN' &amp; name=='UsedCapacity' &amp; svclevel=='Pool Contributor'</filter>
...
[/#if]
    ...
    <aggregation id="VNX-ServiceLevel-FreeCapacity" forward-input="true">
        <filter>parttype=='LUN' &amp; name=='UsedCapacity' &amp; svclevel &amp; isused=='0' &amp; !svclevel=='Pool Contributor'</filter>
