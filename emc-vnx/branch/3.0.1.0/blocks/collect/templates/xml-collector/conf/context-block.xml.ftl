...
[#if vnx.block.use_secfile]
		<properties name="username">sysadmin</properties>
		<properties name="password">sysadmin</properties>
		<properties name="userscope">global</properties>
[#else]
		<properties name="username">${vnx.block.username}</properties>
