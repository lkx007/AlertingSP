...
<config xmlns="http://www.watch4net.com/spatial-aggregation-handler" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <aggregation id="VNX-UNCONFIGURED-CAPACITY" forward-input="true">

        <!-- To filter which metrics are aggregated here. -->
        <filter>(parttype=='Disk' &amp; !dgname  &amp; name=='Capacity')
        | (parttype=='RAID Group' &amp; haslun=='0' &amp; name=='RawCapacity')
        | (parttype=='Storage Pool' &amp; haslun=='0' &amp; name=='RawCapacity')
        | name=='RemoveMeZero'
        </filter>
