...
<config xmlns="http://www.watch4net.com/spatial-aggregation-handler" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.watch4net.com/spatial-aggregation-handler spatial-aggregation-handler.xsd">
	<aggregation id="VNX-SYSTEMRESOURCE-CAPACITY" forward-input="true">
		<filter> device &amp; serialnb &amp; sstype &amp; (internal=='true' &amp; parttype=='FileSystem' &amp; name=='MetaVolumeCapacity') | name=='RemoveMeZero' </filter>
		...
		<properties>
			...
			<add name="name">NASSystemUsedCapacity</add>
