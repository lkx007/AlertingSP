...
[#-- VNX File --]
		<filter enabled="true" name="vnxfile2" next="DataEnrichment" config="Property-Tagging-Filter/${module['property-tagging-filter'].instance}/conf/property-tagging-filter-vnxfile.xml" />
		<filter enabled="true" name="vnxfile-icf3" next="vnxfile2" config="Inline-Calculation-Filter/${module['inline-calculation-filter'].instance}/conf/inline-calculation-filter-vnxfile3.xml" />
		<filter enabled="true" name="vnxfile-icf2" next="vnxfile-icf3" config="Inline-Calculation-Filter/${module['inline-calculation-filter'].instance}/conf/inline-calculation-filter-vnxfile2.xml" />
		...
		<!-- Unity -->
		<filter enabled="true" name="VNXe2-PTF1" next="Backend" config="Property-Tagging-Filter/${module['property-tagging-filter'].instance}/conf/property-tagging-filter-vnxunity.xml" />
		...
		<filter enabled="true" name="VNXe2-VHF1" next="VNXe2-ICF1" config="Variable-Handling-Filter/${module['variable-handling-filter'].instance}/conf/vhf-vnxe2.xml" />
		<filter enabled="true" name="VNXe2-CRF2" next="VNXe2-VHF1" config="Cross-Referencing-Filter/${module['cross-referencing-filter'].instance}/conf/vnx2e2.xml" />
...
[/#if]
		...
		<!-- Unity -->
		<collector enabled="${unityenabled}" name="Unity-Capacity" next="VNXe2-CRF1" config="XML-Collector/${module['xml-collector'].instance}/conf/vnxe2-capacity.xml" />
		<collector enabled="${unityenabled}" name="Unity-Performance" next="VNXe2-CRF1" config="XML-Collector/${module['xml-collector'].instance}/conf/vnxe2-performance.xml" />
	</collectors>
</config>